...
| `crate export TARGET [-o FILE] [-P PASSFILE]` | Експорт запущеного контейнера в .crate (опціональне шифрування) |
| `crate import FILE [-o FILE] [--force] [-P PASSFILE]` | Імпорт .crate з валідацією (авто-розшифрування) |
...
- `.sha256` sidecar покриває **шифротекст**: якщо хочете детектувати
  ...
  розшифровкою.
- Аутентифіковані / асиметричні підписи (ed25519, GPG) — у roadmap'і;
  поки що для цілісності використовуйте SHA256-sidecar.
