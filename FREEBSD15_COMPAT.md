...
### 4.1. Совместимость `nmount()` — OK

**Файл:** `mount.cpp:28-59`

`nmount()` — стабильный FreeBSD syscall, изменений в его поведении для nullfs и devfs
в FreeBSD 15.0 не обнаружено. Код продолжит работать корректно.
...
### 5.4. OCI-совместимые контейнеры
...
### 5.5. pf(4) поддерживает OpenBSD NAT синтаксис
